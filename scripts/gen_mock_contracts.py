...
def gen_low_risk_contract() -> Path:
    ...
    _write_docx(
        ...
        [
            "第一条 合同金额：合同总金额为人民币 1,200,000 元，币种为人民币。",
            "第二条 合同期限：本合同自 2026-08-20 起生效，有效期至 2027-08-19。",
            "第三条 付款条款：合同签订后 10 个工作日内支付预付款 60%；验收合格后 30 日内支付剩余 40%。",
            "第四条 交付条款：乙方应于 2026-12-31 前完成全部货物交付。",
            "第五条 验收条款：甲方应在乙方交付后 15 个工作日内组织验收，验收标准以双方确认的技术协议为准。",
            "第六条 违约条款：任何一方违约，应按合同金额的 10% 支付违约金。",
            "第七条 保密条款：双方应对合同内容及商业秘密承担保密义务，保密期限为合同终止后三年。",
            "第八条 数据条款：乙方处理甲方数据应遵守数据安全法及相关规定。",
            "第九条 知识产权条款：软件相关知识产权归甲方所有。",
            "第十条 争议解决条款：双方争议由合同签订地人民法院管辖。",
        ],
    )
    return path
